...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String[] nama, alamat, gambar, id;
    int jumData;
    ...
    private void getlokasi(){
        String url="https://gispura.000webhostapp.com/pura.php";
                        ...
                        for (int i = 0; i < jumData; i++) {
                            try {
                                ...
                                mMap.addMarker(new MarkerOptions()
                                        .position(latLng[i])
                                        .snippet(alamat[i])
                                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.omm))
                                        .title(nama[i]));
                                ...
                                for (int i = 0; i < jumData; i++) {
                                    if (marker.getTitle().equals(nama[i])) {
                                        ...
                                        if (MarkerD[i]) {
                                            ...
                                            Toast pesan = Toast.makeText(MapsActivity.this, "Klik dua kali untuk melihat detail Pura", Toast.LENGTH_LONG);
